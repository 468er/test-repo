...
public class MainMenu : MonoBehaviour
{
    ...
    public void GoToScene(string sceneName)
    {
        ...
        SaveFileOBJ saveFileOBJ = Newtonsoft.Json.JsonConvert.DeserializeObject<SaveFileOBJ>(pureJson);
        SaveAndLoadManager.Load(saveFileOBJ);
    }
    public void GotoScene()
    {
        SceneManager.LoadScene("Game");
        SaveAndLoadManager.Load(null);
